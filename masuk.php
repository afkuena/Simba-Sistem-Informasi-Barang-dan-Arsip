            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h3 class="mt-4">Penyediaan Barang</h3>
                        ...
                        <div class="card-header bg-success text-white">
                                ...
                                <a href="exportpdfm.php" class="btn btn-info">Cetak</a>
                                <a href="exportexcelm.php" class="btn btn-info">Export Data Excel</a>
                            </div>
                            <div class="card-body">
                            <table class="table table-bordered" id="datatablesSimple" width= "75%" cellspacing= "0">
                                ...
                                <div class="modal fade" id="edit<?=$idb;?>">
                                    ...
                                    <b>Tanggal Masuk :</b>
                                    <br>
                                    <input type="date" name="tanggalmasuk" placeholder="tangal masuk" value="<?=$tglmasuk;?>" class="form-control">
                                    <br>   
                                    <input type="text" name="kodebarang" placeholder="kode barang" value="<?=$kodebarang;?>" class="form-control">
                                    <br>
                                    ...
                                    <br>
                                    <input type="text" name="penerimabm" placeholder="Penerima" value="<?=$penerima;?>" class="form-control">
                                    <br>
                                    <input type="text" name="bahanrangkabarangbm" placeholder="Bahan/No.Rangka" value="<?=$bahanrangkabarang;?>" class="form-control">
                                    <br>
                                    <input type="text" name="sumberdanabm" placeholder="Sumper dana"value="<?=$sumberdana?>" class="form-control">
                                    <br>
                                    <b>Tahun :</b>
                                    <br>
                                    <input type="number" name="tahunbm" placeholder="tahun" value="<?=$tahun;?>" class="form-control">
                                    <br>
                                    <input type="text" name="kondisibarangbm" placeholder="kondisi barang" value="<?=$kondisibarang;?>" class="form-control">
                                    <br>
                                    <input type="number" name="qty" placeholder="quantity" class="form-control" value="<?=$qty;?>">
                                    <br>
                                    <input type="number" name="hargasatuan" placeholder="harga satuan" value="<?=$hargasatuan;?>" class="form-control">
                                    <br>
                                    <input type="number" name="hargatotalbm" placeholder="harga total" value="<?=$hargatotal;?>" class="form-control">
                                    <br>
                                    <input type="text" name="keteranganbm" placeholder="keterangan" value="<?=$keterangan;?>" class="form-control">
                                    <br>
                                    <input type="file" name="file"class="form-control">
                                    <br>
                                    <input type="hidden" name="idmasuk" value="<?=$i;?>">
                                    <br>
  ...
  <div class="modal fade" id="myModal">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form method ="post" enctype="multipart/form-data">
        <div class="modal-body">
        <select  data-bs-spy="scroll" name="barangnya" class="form-control">;
        <br>
            <?php
            $ambilsemuadatanya = mysqli_query($conn, "select * from stock");
            while($fetcharray = mysqli_fetch_array($ambilsemuadatanya)){
        ...
        <br>
        <input type="text" name="penerimabm" placeholder="Penerima" class="form-control"required>
        <br>
        <input type="text" name="bahanrangkabarangbm" placeholder="Bahan / Rangka" class="form-control">
        <br>
        <input type="text" name="sumberdanabm" placeholder="Sumber Dana" class="form-control"required>
        <br>
        <b>Tahun :</b>
        <br>
        <div class="form-label-group">
        <select class= "form-control" name="tahunbm">
        ...
        <br>
        <div class="form-label-group">
        <select class= "form-control" name="kondisibarangbm">
        ...
        <b>Harga Total :</b>
        <br>
        <input type="text" name="hargatotalbm" id= "hargatotalbm">
        <br>
        </div>
        ...
        <script type="text/javascript">
            $(".perhitungan").keyup(function(){
                ...
                var hargasatuanbm = parseInt($("#hargasatuan").val())

                var hargatotalbm = qty * hargasatuanbm;
                $("#hargatotalbm").attr("value",hargatotalbm)
            });
            </script>
            <br>
        <input type="text" name="keteranganbm" placeholder="Keterangan" class="form-control">
        <br>
        <input type="file" name="file"class="form-control"required>
        <br>
        <input type="hidden" name="idmasuk" value="<?=$i;$i++;?>">
        <br>
        <?php
            $ambilsemuadatanya = mysqli_query($conn, "select * from stock");
            while($fetcharray = mysqli_fetch_array($ambilsemuadatanya)){
