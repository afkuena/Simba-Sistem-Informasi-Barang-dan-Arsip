            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h3 class="mt-4">Data Arsip Bidang Anggaran</h3>
                        <div class="card mb-4">
                            ...
                            <table class="table-bordered" id="datatablesSimple" width= "75%" cellspacing= "0">
                                <thead>
                                    ...
                                    <tbody>
                                                        ...
                                                        $ambilsemuadataarsip = mysqli_query($conn, "SELECT * FROM data_arsip WHERE bidang='Anggaran'");
                                                        $i= 0;
...
<!-- Form Input------->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Unggah Berkas Bidang Anggaran</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <select class= "form-control" name="nm_pengunggah">;
                      ...
                      <option value="Kepala Sub Bidang Kebijakan Anggaran">Kepala Sub Bidang Kebijakan Anggaran</option>
                      <option value="Kepala Sub Bidang Penyusunan Anggaran">Kepala Sub Bidang Penyusunan Anggaran</option>
					  ...
					  <option value="Pengelola Data Bidang Anggaran">Pengelola Data Bidang Anggaran</option>
                  </select>
            <br>
