            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h3 class="mt-4">Data Arsip Bidang Perbendaharaan</h3>
                        <div class="card mb-4">
                            ...
                            <table class="table-bordered" id="datatablesSimple" width= "75%" cellspacing= "0">
                                <thead>
                                    ...
                                    <tbody>
                                                        ...
                                                        $ambilsemuadataarsip = mysqli_query($conn, "SELECT * FROM data_arsip WHERE bidang='Perbendaharaan'");
                                                        $i= 0;
                                                        ...
                                                        <button type="button" class="btn btn-warning"><a href="downloadfile.php?fileperbendaharaan=<?=$data['berkas'];?>">Unduh</a></button>
                                                        </div>
                                                         </td>
                                                        </tr>    
...
<!-- Form Input------->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Unggah Berkas Bidang Perbendaharaan</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <select class= "form-control" name="nm_pengunggah">;
                      ...
                      <option value="Kepala Sub Bidang Pengelolaan Pembiayaan dan Dana Transfer">Kepala Sub Bidang Pengelolaan Pembiayaan dan Dana Transfer</option>
                      <option value="Kepala Sub Bidang Manajemen Kas">Kepala Sub Bidang Manajemen Kas</option>
                      <option value="Analis Perbendaharaan">Analis Perbendaharaan</option>
                      <option value="Analis Aplikasi dan Pengelolaan Data Sistem Keuangan">Analis Aplikasi dan Pengelolaan Data Sistem Keuangan</option>
                      <option value="Pengelola Data Pencairan Dana">Pengelola Data Pencairan Dana</option>
                      <option value="Analis Perbendaharaan">Analis Perbendaharaan</option>
                      <option value="Analis Aplikasi dan Pengelolaan Data Sistem Keuangan">Analis Aplikasi dan Pengelolaan Data Sistem Keuangan</option>
        ...
        <br>
        <input type="hidden" name="bidang" value="Perbendaharaan">
        <br>
        	<input type="file" id="file" name="file"  class="form-control"required>
        <br>
        <button type="submit"  id="uploadBtn" class="btn btn-primary" name="Unggahperbendaharaan"><U>Unggah</U></button>
        </div>
        <br>
        <div class="progress">
