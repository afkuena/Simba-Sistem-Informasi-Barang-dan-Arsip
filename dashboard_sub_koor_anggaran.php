                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="sb-sidenav-menu-heading"></div>
                            ...
                            <a class="nav-link" href="dashboard_sub_koor_anggaran.php">
                                <div class="sb-nav-link-icon"><i class="glyphicon glyphicon-save"></i></div>
                                Sub Koordinator Kelompok Sub Substansi Analisis dan Evaluasi Anggaran
                            </a>
                            </nav>
                            </div>
                ...
                <main>
                    <div class="container-fluid px-5">
                        ...
                        <ol class="breadcrumb mb-5">
                            <li class="breadcrumb-item active">Sub Koordinator Kelompok Sub Substansi Analisis dan Evaluasi Anggaran</li>
                        </ol>
                        <div class="row">
                            ...
                            <table class="table table-striped" id="datatablesSimple" width= "75%" cellspacing= "0">
                                <thead>
                                    ...
                                    <tbody>
                                                        ...
                                                        $ambilsemuadataarsip = mysqli_query($conn, "SELECT * FROM data_arsip WHERE nm_pengunggah='Sub Koordinator Kelompok Sub Substansi Analisis dan Evaluasi Anggaran'");
                                                        $i= 0;
                                                        ...
                                                        <button type="button" class="btn btn-warning"><a href="downloadfile.php?fileanggaran=<?=$data['berkas'];?>">Unduh</a></button>
                                                        </div>
                                                         </td>
                                                        </tr>    
...
<!-- Form Input------->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Unggah Berkas Sub Koordinator Kelompok Sub Substansi Analisis dan Evaluasi Anggaran</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <select class= "form-control" name="nm_pengunggah">;
                      <option value="Sub Koordinator Kelompok Sub Substansi Analisis dan Evaluasi Anggaran">Sub Koordinator Kelompok Sub Substansi Analisis dan Evaluasi Anggaran</option>
                  </select>
            <br>
        ...
        <br>
        <input type="hidden" name="bidang" value="Anggaran">
        <br>
        <input type="file" id="file" name="file"  class="form-control"required>
        <br>
        <button type="submit"  id="uploadBtn" class="btn btn-primary" name="Unggahanggaran"><U>Unggah</U></button>
        </div>
        <br>
        <div class="progress">
