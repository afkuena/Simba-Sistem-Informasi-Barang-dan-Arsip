...
<div class="container-fluid px-5">
    ...
    Informasi Data Supplier
     ...
     <table class="table table-striped" id="datatablesSimple" width= "100%" cellspacing= "0">
                                ...
                                <div class="modal fade" id="edit<?=$idsupplier;?>">
                                    ...
                                    <br>
                                    <input type="text" name="namacv" value="<?=$namacv;?>" class="form-control">    
                                    <br>
  ...
  <div class="card-header bg-primary text-white">
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" name="namacv" class="form-control" id="Inputnamacv"  placeholder="Nama Supplier" required>
    </div>
    <div class="col-md-6 mb-3">
