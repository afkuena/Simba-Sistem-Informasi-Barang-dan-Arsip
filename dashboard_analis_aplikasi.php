                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="sb-sidenav-menu-heading"></div>
                            ...
                            <a class="nav-link" href="dashboard_analis_aplikasi.php">
                ...
                <main>
                    <div class="container-fluid px-5">
                        ...
                        <ol class="breadcrumb mb-5">
                            <li class="breadcrumb-item active">Analis Aplikasi dan Pengelolaan Data Sistem Keuangan</li>
                        </ol>
                        <div class="row">
                            ...
                            <table class="table table-striped" id="datatablesSimple" width= "75%" cellspacing= "0">
                                <thead>
                                    ...
                                    <tbody>
                                                        ...
                                                        $ambilsemuadataarsip = mysqli_query($conn, "SELECT * FROM data_arsip WHERE nm_pengunggah='Analis Aplikasi dan Pengelolaan Data Sistem Keuangan'");
                                                        $i= 0;
...
<!-- Form Input------->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Unggah Berkas Analis Aplikasi dan Pengelolaan Data Sistem Keuangan</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
