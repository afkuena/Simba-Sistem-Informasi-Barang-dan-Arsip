...
<html lang="en">
    <head>
        ...
        <title>Validasi Daftar User</title>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table class="table table-condensed" id="datatablesSimple" width= "75%" cellspacing= "0">
                                    ...
                                    <?php
                                    $ambilsemuadataadmin = mysqli_query($conn, "select * from daftaruser");
                                    $i = 1;
                                ...
                                <div class="modal fade" id="edit<?=$iduser;?>">
                                    ...
                                    <form method ="post">
                                    <div class="modal-body">
                                    <b>Yakin Om Mau di Hapus User <?=$namalengkap;?> nya?</b>
                                    <br>
                                    <input type="hidden" name="no_urut" value=<?=$iduser;?>">
                                    <br>
                                    <button type="submit" class="btn btn-danger"name="hapususer">Yakin Hapus</button>
                            </div>
                    </form>
