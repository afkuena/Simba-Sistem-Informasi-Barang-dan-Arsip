                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="sb-sidenav-menu-heading"></div>
                            ...
                            <a class="nav-link" href="dashboard_proglap.php">
                                <div class="sb-nav-link-icon"><i class="glyphicon glyphicon-save"></i></div>
                                Sub Koordinator Kelompok Sub Substansi Program dan Pelaporan
                            </a>
                            </nav>
                            </div>
                ...
                <main>
                    <div class="container-fluid px-5">
                        ...
                        <ol class="breadcrumb mb-5">
                            <li class="breadcrumb-item active">Sub Koordinator Kelompok Sub Substansi Program dan Pelaporan</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary shadow h-200 py-2 text-white mb-5">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="dashboard_sekban.php"><?=$countproglap;?> file</a>
                            ...
                            <table class="table table-striped" id="datatablesSimple" width= "75%" cellspacing= "0">
                                <thead>
                                    ...
                                    <tbody>
                                                        ...
                                                        $ambilsemuadataarsip = mysqli_query($conn, "SELECT * FROM data_arsip WHERE nm_pengunggah='Sub Koordinator Kelompok Sub Substansi Program dan Pelaporan'");
                                                        $i= 0;
                                                        ...
                                                        <button type="button" class="btn btn-warning"><a href="downloadfile.php?filename=<?=$data['berkas'];?>">Unduh</a></button>
                                                        </div>
                                                         </td>
                                                        </tr>    
...
<!-- Form Input------->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Unggah Berkas Sub Koordinator Kelompok Sub Substansi Program dan Pelaporan</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <select class= "form-control" name="nm_pengunggah">;
                      <option value="Sub Koordinator Kelompok Sub Substansi Program dan Pelaporan">Sub Koordinator Kelompok Sub Substansi Program dan Pelaporan</option>
                  </select>
            <br>
        ...
        <br>
        <button type="submit"  id="uploadBtn" class="btn btn-primary" name="Unggah"><U>Unggah</U></button>
        </div>
        <br>
        <div class="progress">
