...
$getop_sekret = mysqli_query($conn,"select * from data_arsip where nm_pengunggah='Pengelola Data Sekretariat'");
$countop_sekret = mysqli_num_rows($getop_sekret);
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    <div class="sb-sidenav-menu">
                        ...
                        <div class="sb-sidenav-menu-heading"></div>
                            ...
                            <a class="nav-link" href="dashboard_operator1.php">
                                <div class="sb-nav-link-icon"><i class="glyphicon glyphicon-save"></i></div>
                                Pengelola Data Sekretariat
                            </a>
                            </nav>
                            </div>
                ...
                <main>
                    <div class="container-fluid px-5">
                        ...
                        <ol class="breadcrumb mb-5">
                            <li class="breadcrumb-item active">Pengelola Data Sekretariat</li>
                        </ol>
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary shadow h-200 py-2 text-white mb-5">
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="dashboard_operator1.php"><?=$countop_sekret;?> file</a>
                            ...
                            <table class="table table-striped" id="datatablesSimple" width= "75%" cellspacing= "0">
                                <thead>
                                    ...
                                    <tbody>
                                                        ...
                                                        $ambilsemuadataarsip = mysqli_query($conn, "SELECT * FROM data_arsip WHERE nm_pengunggah='Pengelola Data Sekretariat'");
                                                        $i= 0;
...
<!-- Form Input------->
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <!-- Modal Header -->
        <div class="modal-header">
          <h4 class="modal-title">Unggah Berkas Pengelola Data Sekretariat</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        ...
        <select class= "form-control" name="nm_pengunggah">;
                      <option value="Pengelola Data Sekretariat">Pengelola Data Sekretariat</option>
                  </select>
            <br>
